...
Sidebar.Material = function (editor, eventHub) {
	...
	let materialSlotRow = new UI.Row();

	materialSlotRow.add(new UI.Text('Slot').setWidth('90px'));

	let materialSlotSelect = new UI.Select().setWidth('170px').setFontSize('12px').onChange(update);
	...
	let materialClassRow = new UI.Row();
	let materialClass = new UI.Select().setOptions({
	...
	let materialUUIDRow = new UI.Row();
	let materialUUID = new UI.Input().setWidth('102px').setFontSize('12px').setDisabled(true);
	let materialUUIDRenew = new UI.Button('New').setMarginLeft('7px').onClick(function () {
	...
	let materialNameRow = new UI.Row();
	let materialName = new UI.Input().setWidth('150px').setFontSize('12px').onChange(function () {
	...
	let materialProgramRow = new UI.Row();
	materialProgramRow.add(new UI.Text('Program').setWidth('90px'));

	let materialProgramInfo = new UI.Button('Info');
	...
	let materialProgramVertex = new UI.Button('Vertex');
	...
	let materialProgramFragment = new UI.Button('Fragment');
	...
	let materialColorRow = new UI.Row();
	let materialColor = new UI.Color().onChange(update);
	...
	let materialRoughnessRow = new UI.Row();
	let materialRoughness = new UI.Number(0.5).setWidth('60px').setRange(0, 1).onChange(update);
	...
	let materialMetalnessRow = new UI.Row();
	let materialMetalness = new UI.Number(0.5).setWidth('60px').setRange(0, 1).onChange(update);
	...
	let materialEmissiveRow = new UI.Row();
	let materialEmissive = new UI.Color().setHexValue(0x000000).onChange(update);
	...
	let materialSpecularRow = new UI.Row();
	let materialSpecular = new UI.Color().setHexValue(0x111111).onChange(update);
	...
	let materialShininessRow = new UI.Row();
	let materialShininess = new UI.Number(30).onChange(update);
	...
	let materialClearCoatRow = new UI.Row();
	let materialClearCoat = new UI.Number(1).setWidth('60px').setRange(0, 1).onChange(update);
	...
	let materialClearCoatRoughnessRow = new UI.Row();
	let materialClearCoatRoughness = new UI.Number(1).setWidth('60px').setRange(0, 1).onChange(update);
	...
	let materialVertexColorsRow = new UI.Row();
	let materialVertexColors = new UI.Select().setOptions({
		0: 'No',
		1: 'Face',
		2: 'Vertex'
	}).onChange(update);
	...
	let materialSkinningRow = new UI.Row();
	let materialSkinning = new UI.Checkbox(false).onChange(update);
	...
	let materialMapRow = new UI.Row();
	let materialMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialMap = new UI.Texture().onChange(update);
	...
	let materialAlphaMapRow = new UI.Row();
	let materialAlphaMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialAlphaMap = new UI.Texture().onChange(update);
	...
	let materialBumpMapRow = new UI.Row();
	let materialBumpMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialBumpMap = new UI.Texture().onChange(update);
	let materialBumpScale = new UI.Number(1).setWidth('30px').onChange(update);
	...
	let materialNormalMapRow = new UI.Row();
	let materialNormalMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialNormalMap = new UI.Texture().onChange(update);
	...
	let materialDisplacementMapRow = new UI.Row();
	let materialDisplacementMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialDisplacementMap = new UI.Texture().onChange(update);
	let materialDisplacementScale = new UI.Number(1).setWidth('30px').onChange(update);
	...
	let materialRoughnessMapRow = new UI.Row();
	let materialRoughnessMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialRoughnessMap = new UI.Texture().onChange(update);
	...
	let materialMetalnessMapRow = new UI.Row();
	let materialMetalnessMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialMetalnessMap = new UI.Texture().onChange(update);
	...
	let materialSpecularMapRow = new UI.Row();
	let materialSpecularMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialSpecularMap = new UI.Texture().onChange(update);
	...
	let materialEnvMapRow = new UI.Row();
	let materialEnvMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialEnvMap = new UI.Texture(THREE.SphericalReflectionMapping).onChange(update);
	let materialReflectivity = new UI.Number(1).setWidth('30px').onChange(update);
	...
	let materialLightMapRow = new UI.Row();
	let materialLightMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialLightMap = new UI.Texture().onChange(update);
	...
	let materialAOMapRow = new UI.Row();
	let materialAOMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialAOMap = new UI.Texture().onChange(update);
	let materialAOScale = new UI.Number(1).setRange(0, 1).setWidth('30px').onChange(update);
	...
	let materialEmissiveMapRow = new UI.Row();
	let materialEmissiveMapEnabled = new UI.Checkbox(false).onChange(update);
	let materialEmissiveMap = new UI.Texture().onChange(update);
	...
	let materialSideRow = new UI.Row();
	let materialSide = new UI.Select().setOptions({
		0: 'Front',
		1: 'Back',
		2: 'Double'
	} ).setWidth('150px').setFontSize('12px').onChange(update);
	...
	let materialShadingRow = new UI.Row();
	let materialShading = new UI.Checkbox(false).setLeft('100px').onChange(update);
	...
	let materialBlendingRow = new UI.Row();
	let materialBlending = new UI.Select().setOptions({
		0: 'No',
		1: 'Normal',
		2: 'Additive',
		3: 'Subtractive',
	...
	let materialOpacityRow = new UI.Row();
	let materialOpacity = new UI.Number(1).setWidth('60px').setRange(0, 1).onChange(update);
	...
	let materialTransparentRow = new UI.Row();
	let materialTransparent = new UI.Checkbox().setLeft('100px').onChange(update);
	...
	let materialAlphaTestRow = new UI.Row();
	let materialAlphaTest = new UI.Number().setWidth('60px').setRange(0, 1).onChange(update);
	...
	let materialWireframeRow = new UI.Row();
	let materialWireframe = new UI.Checkbox(false).onChange(update);
	let materialWireframeLinewidth = new UI.Number(1).setWidth('60px').setRange(0, 100).onChange(update);
	...
	function update() {
		...
		let previousSelectedSlot = currentMaterialSlot;
		...
		if (material) {
			...
			if (material instanceof THREE[materialClass.getValue()] === false) {
				...
				editor.execute(new SetMaterialCommand(currentObject, material, currentMaterialSlot), 'New Material: ' + materialClass.getValue());
				// TODO Copy other references in the scene graph keeping name and UUID then.
				// Also there should be means to create a unique copy for the current object
				// explicitly and to attach the current material to other objects.
			}
			...
			if (material.flatShading !== undefined) {
				let flatShading = materialShading.getValue();
